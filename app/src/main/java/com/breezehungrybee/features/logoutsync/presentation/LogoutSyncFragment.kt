package com.breezehungrybee.features.logoutsync.presentation
...
import com.breezehungrybee.CustomConstants


import com.breezehungrybee.R
import com.breezehungrybee.app.AppDatabase
...
import com.breezehungrybee.app.utils.Toaster
import com.breezehungrybee.base.BaseResponse
import com.breezehungrybee.base.presentation.BaseActivity
import com.breezehungrybee.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezehungrybee.features.billing.api.AddBillingRepoProvider
import com.breezehungrybee.features.billing.model.AddBillingInputParamsModel
...
import com.breezehungrybee.features.dashboard.presentation.ReasonDialog
...
import com.breezehungrybee.features.document.model.AddEditDocumentInputParams
import com.breezehungrybee.features.document.model.DocumentAttachmentModel
...
import com.breezehungrybee.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezehungrybee.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezehungrybee.features.orderhistory.model.*
...
import com.breezehungrybee.features.quotation.model.AddQuotInputModel
import com.breezehungrybee.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezehungrybee.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezehungrybee.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezehungrybee.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezehungrybee.features.stockCompetetorStock.ShopAddCompetetorStockRequest
...
import com.breezehungrybee.features.timesheet.model.AddTimeSheetInputModel
import com.breezehungrybee.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezehungrybee.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezehungrybee.features.viewAllOrder.model.AddOrderInputProductList
import com.breezehungrybee.mappackage.SendBrod
import com.breezehungrybee.widgets.AppCustomTextView
import com.breezehungrybee.MonitorService
import com.breezehungrybee.MySingleton
import com.breezehungrybee.app.AlarmReceiver
...
import com.breezehungrybee.features.addshop.presentation.ShopExtraContactReq
...
import com.breezehungrybee.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezehungrybee.features.login.model.GetConcurrentUserResponse
import com.breezehungrybee.features.login.model.WhatsappApiData
import com.breezehungrybee.features.orderITC.SyncDeleteOppt
import com.breezehungrybee.features.orderITC.SyncDeleteOpptL
import com.breezehungrybee.features.orderITC.SyncEditOppt
import com.breezehungrybee.features.orderITC.SyncOppt
import com.breezehungrybee.features.orderITC.SyncOpptProductL
import com.breezehungrybee.features.orderITC.SyncOrd
import com.breezehungrybee.features.orderITC.SyncOrdProductL
import com.breezehungrybee.features.performance.model.Gps_status_list
import com.breezehungrybee.features.performance.model.UpdateGpsInputListParamsModel
import com.breezehungrybee.features.returnsOrder.ReturnProductList
import com.breezehungrybee.features.returnsOrder.ReturnRequest
import com.breezehungrybee.features.viewAllOrder.model.NewOrderSaveApiModel
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezehungrybee/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezehungrybeelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezehungrybeelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezehungrybeelogsample/log.zip").path);

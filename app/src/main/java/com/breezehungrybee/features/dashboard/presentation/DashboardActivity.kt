package com.breezehungrybee.features.dashboard.presentation
...
import com.breezehungrybee.*
import com.breezehungrybee.R
import com.breezehungrybee.app.*
import com.breezehungrybee.app.NewFileUtils.browseDocuments
import com.breezehungrybee.app.NewFileUtils.browsePDFDocuments
import com.breezehungrybee.app.NewFileUtils.getExtension
import com.breezehungrybee.app.domain.*
import com.breezehungrybee.app.types.DashboardType
import com.breezehungrybee.app.types.FragType
import com.breezehungrybee.app.types.TopBarConfig
import com.breezehungrybee.app.uiaction.DisplayAlert
import com.breezehungrybee.app.utils.*
import com.breezehungrybee.app.utils.AppUtils.Companion.isProfile
import com.breezehungrybee.base.BaseResponse
import com.breezehungrybee.base.presentation.BaseActivity
import com.breezehungrybee.base.presentation.BaseFragment
import com.breezehungrybee.features.NewQuotation.*
import com.breezehungrybee.features.NewQuotation.api.GetQuotRegProvider
import com.breezehungrybee.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezehungrybee.features.SearchLocation.SearchLocationFragment
import com.breezehungrybee.features.SearchLocation.locationInfoModel
import com.breezehungrybee.features.TA.ViewAllTAListFragment
import com.breezehungrybee.features.achievement.AchievementFragment
import com.breezehungrybee.features.activities.presentation.*
import com.breezehungrybee.features.addAttendence.*
import com.breezehungrybee.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezehungrybee.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezehungrybee.features.addAttendence.model.GetReportToFCMResponse
import com.breezehungrybee.features.addAttendence.model.GetReportToResponse
import com.breezehungrybee.features.addAttendence.model.Leave_list_Response
import com.breezehungrybee.features.addorder.presentation.AddOrderFragment
...
import com.breezehungrybee.features.addshop.presentation.AddShopFragment
import com.breezehungrybee.features.addshop.presentation.OTPVerificationDialog
import com.breezehungrybee.features.addshop.presentation.ScanImageFragment
import com.breezehungrybee.features.addshop.presentation.ShowCardDetailsDialog
import com.breezehungrybee.features.alarm.model.AlarmData
import com.breezehungrybee.features.alarm.presetation.AttendanceReportFragment
import com.breezehungrybee.features.alarm.presetation.PerformanceReportFragment
import com.breezehungrybee.features.alarm.presetation.VisitReportDetailsFragment
import com.breezehungrybee.features.alarm.presetation.VisitReportFragment
import com.breezehungrybee.features.attendance.AttendanceFragment
import com.breezehungrybee.features.attendance.api.AttendanceRepositoryProvider
import com.breezehungrybee.features.attendance.model.AttendanceRequest
import com.breezehungrybee.features.attendance.model.AttendanceResponse
import com.breezehungrybee.features.averageshop.presentation.AverageShopFragment
import com.breezehungrybee.features.avgorder.presentation.AverageOrderFragment
import com.breezehungrybee.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezehungrybee.features.beatCustom.TeamBeatListFragment
import com.breezehungrybee.features.billing.presentation.AddBillingFragment
import com.breezehungrybee.features.billing.presentation.BillingDetailsFragment
import com.breezehungrybee.features.billing.presentation.BillingListFragment
import com.breezehungrybee.features.changepassword.presentation.ChangePasswordDialog
import com.breezehungrybee.features.chat.model.ChatListDataModel
import com.breezehungrybee.features.chat.model.ChatUserDataModel
import com.breezehungrybee.features.chat.model.GroupUserDataModel
import com.breezehungrybee.features.chat.presentation.*
import com.breezehungrybee.features.chatbot.presentation.ChatBotFragment
import com.breezehungrybee.features.chatbot.presentation.ChatBotShopListFragment
import com.breezehungrybee.features.chatbot.presentation.ReportsFragment
import com.breezehungrybee.features.chatbot.presentation.SelectLanguageDialog
import com.breezehungrybee.features.commondialog.presentation.CommonDialog
import com.breezehungrybee.features.commondialog.presentation.CommonDialogClickListener
import com.breezehungrybee.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezehungrybee.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezehungrybee.features.commondialogsinglebtn.OnDialogClickListener
import com.breezehungrybee.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezehungrybee.features.contacts.ActivityDtlsFrag
import com.breezehungrybee.features.contacts.AddOpptFrag
import com.breezehungrybee.features.contacts.ContactDtls
import com.breezehungrybee.features.contacts.ContactGr
import com.breezehungrybee.features.contacts.ContactsAddFrag
import com.breezehungrybee.features.contacts.ContactsFrag
import com.breezehungrybee.features.contacts.SchedulerAddFormFrag
import com.breezehungrybee.features.contacts.SchedulerViewFrag
import com.breezehungrybee.features.contacts.TemplateAddFrag
import com.breezehungrybee.features.contacts.TemplateViewFrag
import com.breezehungrybee.features.contacts.ViewCrmOpptFrag
import com.breezehungrybee.features.dailyPlan.prsentation.AllShopListFragment
import com.breezehungrybee.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezehungrybee.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezehungrybee.features.damageProduct.ShopDamageProductListFrag
import com.breezehungrybee.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezehungrybee.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezehungrybee.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezehungrybee.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezehungrybee.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezehungrybee.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezehungrybee.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezehungrybee.features.dashboard.presentation.model.ContentListResponseModel
import com.breezehungrybee.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezehungrybee.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezehungrybee.features.device_info.presentation.DeviceInfoListFragment
import com.breezehungrybee.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezehungrybee.features.document.DocumentRepoFeatureNewFragment
import com.breezehungrybee.features.document.presentation.DocumentListFragment
import com.breezehungrybee.features.document.presentation.DocumentTypeListFragment
import com.breezehungrybee.features.document.presentation.OpenFileWebViewFragment
import com.breezehungrybee.features.dymanicSection.presentation.AddDynamicFragment
import com.breezehungrybee.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezehungrybee.features.dymanicSection.presentation.DynamicListFragment
import com.breezehungrybee.features.dymanicSection.presentation.EditDynamicFragment
import com.breezehungrybee.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezehungrybee.features.home.presentation.HomeFragment
import com.breezehungrybee.features.homelocation.presentation.HomeLocationFragment
import com.breezehungrybee.features.homelocation.presentation.HomeLocationMapFragment
import com.breezehungrybee.features.know_your_state.KnowYourStateFragment
import com.breezehungrybee.features.lead.LeadFrag
import com.breezehungrybee.features.lead.ViewLeadFrag
import com.breezehungrybee.features.leaderboard.LeaderBoardFrag
import com.breezehungrybee.features.leaveapplynew.LeaveHome
import com.breezehungrybee.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezehungrybee.features.localshops.LocalShopListFragment
import com.breezehungrybee.features.localshops.LocalShopListMapFragment
import com.breezehungrybee.features.localshops.NearByShopsMapFragment
import com.breezehungrybee.features.location.*
import com.breezehungrybee.features.location.api.LocationRepoProvider
import com.breezehungrybee.features.location.model.*
import com.breezehungrybee.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezehungrybee.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezehungrybee.features.login.ShopFeedbackEntity
import com.breezehungrybee.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezehungrybee.features.login.presentation.LoginActivity
import com.breezehungrybee.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezehungrybee.features.logoutsync.presentation.LogoutSyncFragment
import com.breezehungrybee.features.marketAssist.MarketAssistTabFrag
import com.breezehungrybee.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezehungrybee.features.marketAssist.ShopListMarketAssistFrag
import com.breezehungrybee.features.marketing.presentation.MarketingPagerFragment
import com.breezehungrybee.features.meetinglist.prsentation.MeetingListFragment
import com.breezehungrybee.features.member.MapViewForTeamFrag
import com.breezehungrybee.features.member.model.TeamLocDataModel
import com.breezehungrybee.features.member.model.TeamShopListDataModel
import com.breezehungrybee.features.member.presentation.*
import com.breezehungrybee.features.menuBeat.MenuBeatFrag
import com.breezehungrybee.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezehungrybee.features.micro_learning.presentation.MicroLearningListFragment
import com.breezehungrybee.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezehungrybee.features.myallowancerequest.MyallowanceRequestFragment
import com.breezehungrybee.features.myjobs.model.CustomerDataModel
import com.breezehungrybee.features.myjobs.presentation.*
import com.breezehungrybee.features.mylearning.MyLearningFragment
import com.breezehungrybee.features.myorder.presentation.MyOrderListFragment
import com.breezehungrybee.features.myprofile.presentation.MyProfileFragment
import com.breezehungrybee.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezehungrybee.features.nearbyshops.model.ShopData
import com.breezehungrybee.features.nearbyshops.model.ShopListResponse
import com.breezehungrybee.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezehungrybee.features.nearbyshops.presentation.BeatListFragment
import com.breezehungrybee.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezehungrybee.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezehungrybee.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezehungrybee.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezehungrybee.features.newcollection.CollectionDetailsStatusFragment
import com.breezehungrybee.features.newcollection.CollectionShopListFragment
import com.breezehungrybee.features.newcollection.NewCollectionListFragment
import com.breezehungrybee.features.newcollectionreport.*
import com.breezehungrybee.features.notification.NotificationFragment
import com.breezehungrybee.features.orderITC.CartListFrag
import com.breezehungrybee.features.orderITC.OrderListFrag
import com.breezehungrybee.features.orderITC.ProductListFrag
import com.breezehungrybee.features.orderITC.ViewNewOrdHisAllFrag
import com.breezehungrybee.features.orderITC.ViewNewOrdHistoryFrag
import com.breezehungrybee.features.orderITC.ViewOrdDtls
import com.breezehungrybee.features.orderList.NewDateWiseOrderListFragment
import com.breezehungrybee.features.orderList.NewOrderListFragment
import com.breezehungrybee.features.orderList.OrderListFragment
import com.breezehungrybee.features.orderdetail.presentation.OrderDetailFragment
import com.breezehungrybee.features.orderhistory.ActivityMapFragment
import com.breezehungrybee.features.orderhistory.OrderhistoryFragment
import com.breezehungrybee.features.orderhistory.TimeLineFragment
import com.breezehungrybee.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezehungrybee.features.orderhistory.model.FetchLocationRequest
import com.breezehungrybee.features.orderhistory.model.FetchLocationResponse
import com.breezehungrybee.features.orderhistory.model.LocationData
import com.breezehungrybee.features.pendinglocationinout.PendingOutLocationFrag
import com.breezehungrybee.features.performance.GpsStatusFragment
import com.breezehungrybee.features.performance.PerformanceFragment
import com.breezehungrybee.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezehungrybee.features.performance.model.UpdateGpsInputParamsModel
import com.breezehungrybee.features.performanceAPP.OwnPerformanceFragment
import com.breezehungrybee.features.performanceAPP.PerformanceAppFragment
import com.breezehungrybee.features.performanceAPP.allPerformanceFrag
import com.breezehungrybee.features.permissionList.ViewPermissionFragment
import com.breezehungrybee.features.photoReg.*
import com.breezehungrybee.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezehungrybee.features.quotation.presentation.*
import com.breezehungrybee.features.reimbursement.presentation.*
import com.breezehungrybee.features.report.presentation.*
import com.breezehungrybee.features.returnsOrder.*
import com.breezehungrybee.features.settings.presentation.SettingsFragment
import com.breezehungrybee.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezehungrybee.features.shopdetail.presentation.*
import com.breezehungrybee.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezehungrybee.features.stock.StockDetailsFragment
import com.breezehungrybee.features.stock.StockListFragment
import com.breezehungrybee.features.stockAddCurrentStock.AddShopStockFragment
import com.breezehungrybee.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezehungrybee.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezehungrybee.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezehungrybee.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezehungrybee.features.stockCompetetorStock.CompetetorStockFragment
import com.breezehungrybee.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezehungrybee.features.survey.SurveyFrag
import com.breezehungrybee.features.survey.SurveyViewDtlsFrag
import com.breezehungrybee.features.survey.SurveyViewFrag
import com.breezehungrybee.features.task.presentation.AddTaskFragment
import com.breezehungrybee.features.task.presentation.CalenderTaskFragment
import com.breezehungrybee.features.task.presentation.EditTaskFragment
import com.breezehungrybee.features.task.presentation.TaskListFragment
import com.breezehungrybee.features.taskManagement.TaskManagementFrag
import com.breezehungrybee.features.taskManagement.ViewTaskManagementFrag
import com.breezehungrybee.features.timesheet.presentation.AddTimeSheetFragment
import com.breezehungrybee.features.timesheet.presentation.EditTimeSheetFragment
import com.breezehungrybee.features.timesheet.presentation.TimeSheetListFragment
import com.breezehungrybee.features.viewAllOrder.CartFragment
import com.breezehungrybee.features.viewAllOrder.OrderTypeListFragment
import com.breezehungrybee.features.viewAllOrder.ViewAllOrderListFragment
import com.breezehungrybee.features.viewAllOrder.ViewCartFragment
import com.breezehungrybee.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezehungrybee.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezehungrybee.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezehungrybee.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezehungrybee.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezehungrybee.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezehungrybee.features.viewPPDDStock.ViewOutstandingFragment
import com.breezehungrybee.features.viewPPDDStock.ViewPPDDListFragment
import com.breezehungrybee.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezehungrybee.features.viewPPDDStock.ViewStockFragment
import com.breezehungrybee.features.weather.presentation.WeatherFragment
import com.breezehungrybee.mappackage.MapActivity
import com.breezehungrybee.mappackage.MapActivityWithoutPath
import com.breezehungrybee.mappackage.SendBrod
import com.breezehungrybee.widgets.AppCustomEditText
...
import com.breezehungrybee.features.addshop.model.AudioFetchDataCLass
import com.breezehungrybee.features.login.api.opportunity.OpportunityRepoProvider
import com.breezehungrybee.features.login.model.NewSettingsResponseModel
import com.breezehungrybee.features.mylearning.AllTopicsWiseContents
import com.breezehungrybee.features.mylearning.BookmarkFetchResponse
import com.breezehungrybee.features.mylearning.BookmarkFrag
import com.breezehungrybee.features.mylearning.BookmarkPlayFrag
import com.breezehungrybee.features.mylearning.KnowledgeHubAllVideoList
import com.breezehungrybee.features.mylearning.LeaderboardLmsFrag
import com.breezehungrybee.features.mylearning.LmsQuestionAnswerSet
import com.breezehungrybee.features.mylearning.MyLearningAllVideoList
import com.breezehungrybee.features.mylearning.MyLearningTopicList
import com.breezehungrybee.features.mylearning.MyLearningVideoPlay
import com.breezehungrybee.features.mylearning.MyPerformanceFrag
import com.breezehungrybee.features.mylearning.MyTopicsWiseContents
import com.breezehungrybee.features.mylearning.NotificationLMSFragment
import com.breezehungrybee.features.mylearning.SearchLmsFrag
import com.breezehungrybee.features.mylearning.SearchLmsKnowledgeFrag
import com.breezehungrybee.features.mylearning.SearchLmsLearningFrag
import com.breezehungrybee.features.mylearning.VideoPlayLMS
import com.breezehungrybee.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezehungrybeelogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezehungrybeelogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezehungrybee/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezehungrybeelogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezehungrybeelogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezehungrybeelogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }

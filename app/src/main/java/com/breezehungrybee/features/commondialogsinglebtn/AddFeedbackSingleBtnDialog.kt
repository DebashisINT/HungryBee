package com.breezehungrybee.features.commondialogsinglebtn
...
import com.breezehungrybee.app.domain.ShopVisitCompetetorModelEntity
import com.breezehungrybee.app.domain.VisitRemarksEntity
...
import com.breezehungrybee.features.addshop.presentation.ProspectListDialog
import com.breezehungrybee.features.dashboard.presentation.DashboardActivity
import com.breezehungrybee.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezehungrybee.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezehungrybee/files", "recorded_audio${System.currentTimeMillis()}.mp3")
